...
* [French translation](https://github.com/rodinux/rails_admin_import-fr/blob/master/config/locales/import.fr.yml) by Rodolphe Robles. A suggestion is to translate rails admin and resolve an issue with DatePicker [Rails admin fr](https://github.com/rodinux/rails_admin_import.fr-MX.yml)
